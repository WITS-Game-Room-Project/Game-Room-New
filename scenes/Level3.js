...
function addGround(){
  ...
  let geo = new THREE.BoxGeometry(10000,10000,1);
  let maty = new THREE.MeshStandardMaterial({color: 0xff0000, transparent: true}); //, wireframe: true
  ground = new THREE.Mesh(geo,maty);
  ground.rotateX(Math.PI/2);
  ground.position.set(0,19,0);
...
function addEnemy(x,y,z){
  ...
  eye1.position.set(0.5*4,0.5,1.5);

  eye2.position.set(-0.5*4,0.5,1.5);

  eye3.position.set(0.5*4,0.5,-1.5);

  eye4.position.set(-0.5*4,0.5,-1.5);
